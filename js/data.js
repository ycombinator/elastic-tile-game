var data = {
  ...
  "Logstash": [
    ...
    { value: 400, answers: [
      ...
      "The name of the filter plugin that allows you to rename, replace, and modify fields in your events"
      ]
    },
    { value: 600, answers: [
      "This is the name of the transport protocol used by Logstash Forwarder (Think Paul Bunyan)",
      "The name of the filter plugin that translates IP addresses in your data to geographical locations"
      ]
    },
    { value: 1000, answers: [
      "The name of the command line flag that tests the validity of your Logstash configuration file",
      "The name of the command line flag that sets the number of filter worker threads",
      "This is the minimum number of threads used by Logstash"
      ]
    }
  ],
  "Kibana": [
